...
SVC_NAME="actions.runner.kenlasko-docker-rpi2.github-runner-46bPuHo0JQwlB.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (kenlasko-docker-rpi2.github-runner-46bPuHo0JQwlB)"
